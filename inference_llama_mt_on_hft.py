...
def inference_in_batch(args):
    ...
    # Load checkpoint
    enc_model_name = "hFT"
    checkpoint_path = Path("checkpoints/train_llama_mt_on_hft/AudioLlama_hft_embedding_B_freeze_finetune+vel_model/step=120000_encoder.pth")
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_on_hft/AudioLlama_hft_embedding_B_freeze_finetune+vel_model/step=120000_vel.pth")
    vel_model.load_state_dict(torch.load(checkpoint_path))
    vel_model.to(device)

    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_on_hft/AudioLlama_hft_embedding_B_freeze_finetune+vel_model/step=120000.pth")
    config = EncDecConfig(
    ...
    onset_midis_dir = Path("pred_midis", filename + "AudioLlama_hft_embedding_B_+vel_mocel")
