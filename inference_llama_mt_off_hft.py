...
def inference_in_batch(args):
    ...
    # Load checkpoint
    enc_model_name = "hFT"
    checkpoint_path = Path("checkpoints/train_llama_mt_off_hft/AudioLlama_hft_embedding_A/step=250000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_off_hft/AudioLlama_hft_embedding_A/step=250000.pth")
    config = EncDecConfig(
    ...
    onset_midis_dir = Path("pred_midis_vel", "inference_llama_mt_vel_hft")
