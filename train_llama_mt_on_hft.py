...
def train(args):
    ...
    # Load checkpoint
    enc_model_name = "hFT"
    checkpoint_path = Path("checkpoints/train_llama_mt_on_hft/AudioLlama_hft_embedding_B_freeze_+vel_model/step=180000_encoder.pth")
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_on_hft/AudioLlama_hft_embedding_B_freeze_+vel_model/step=180000_vel.pth")
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_on_hft/AudioLlama_hft_embedding_B_freeze_+vel_model/step=180000.pth")
